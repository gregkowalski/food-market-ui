...
export default class ProfileView extends React.Component {
    ...
    render() {
        ...
        if (!this.user) {
            ...
            content =
                <div className="profileedit-flex-container">
                    <div className="profileedit-flex-item-left">
                        <div className='profileedit-head-left'>
                            <div className='profileedit-verify'>
                                <Segment style={{ textAlign: 'left', fontWeight: 'bold' }} secondary attached='top'>
                                    <div className='profileedit-card-header'>Verified info</div>
                                </Segment>
                                <Segment style={{ textAlign: 'center' }} attached>
                                    <div className='profileedit-verify-items'>
                            ...
                            <div className='profileedit-verify'>
                                <Segment style={{ textAlign: 'left', marginTop: '20px', fontWeight: 'bold' }} secondary attached='top'>
                                    <div className='profileedit-card-header'> About Me</div>
                                </Segment>
                                <Segment style={{ textAlign: 'center' }} attached>
                                    {this.user &&
                                        <div className='profileedit-verify-items'>
                        ...
                        <Grid>
                            <Grid.Column style={{ padding: '0px' }} mobile={16} tablet={16} computer={13}>
                                <div className='profileedit-body'>
                                    ...
                                    <Header className='profileedit-header' as='h1'>Hi, I'm {this.user.name}! </Header>
                                    <div className='profileedit-sub-header'>
                                    ...
                                    <div style={{ clear: 'both' }}></div>
                                    <div className='profileedit-user-info'>{this.user.info}</div>
                                    <div style={{ textAlign: 'center', color: '#5e5d5d' }}>
                                        <Segment>
                                            <Form noValidate autoComplete='off'>
                                                <Form.Field>
                                                    <label>Email</label>
                                                    <Input readOnly className='profileedit-email-input' name='email' value={this.state.email} />
