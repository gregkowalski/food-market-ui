...
import './DeliveryOptionFilter.css'
import { SingleDatePicker } from 'react-dates';
import 'react-dates/lib/css/_datepicker.css';
import Util from '../services/Util'

export default class DeliveryOptionFilter extends React.Component {
    ...
    render() {
        ...
        return (
            <div className='deliveryoptionfilter' style={style}>

                <div className={mobile ? 'deliveryoptionfilter-layout-mobile' : 'deliveryoptionfilter-layout'}>

                    {!mobile &&
                        <div id='deliveryoptionfilter-date'>
                            <Button color='grey' {...this.getButtonProps(date)} onClick={this.props.onDateFilterClick}>{dateLabel}</Button>
                        </div>
                    }
                    <div id={mobile ? 'deliveryoptionfilter-pickup-mobile' : 'deliveryoptionfilter-pickup'}>
                    ...
                    {!mobile &&
                        <div id='deliveryoptionfilter-expand'>
...
class DateModal extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <Modal id='deliveryoptionfilter-datepicker' dimmer={false} open={open} onClose={this.props.onClose}>
                    <Modal.Content>
                        <SingleDatePicker
                            date={date}
                            ...
                            numberOfMonths={1}
                        />
                        <div id='deliveryoptionfilter-datepicker-actions'>
